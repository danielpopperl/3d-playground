...
export default function Lights() {
  ...
  useEffect(() => {
    ...
    if (light1Ref.current && window !== "undefined") {
      ...
      gui
        .add(light1Ref.current, "distance", -100, 100, 0.00001)
        .name("distance");
      ...
      //   lookAtFolder
      //     .add(lookAtTarget.current, "x", -20, 20, 0.00001)
      //     .name("Target X")
      //     .onChange((value) => {
      //       lookAtTarget.current.x = value;
      //       light1Ref.current.lookAt(
      ...
      //   lookAtFolder
      //     .add(lookAtTarget.current, "y", -20, 20, 0.00001)
      //     .name("Target Y")
      //     .onChange((value) => {
      ...
      //   lookAtFolder
      //     .add(lookAtTarget.current, "z", 0, 20, 0.00001)
      //     .name("Target Z")
      //     .onChange((value) => {
      //       lookAtTarget.current.z = value;
      //       return light1Ref.current.lookAt(
      //         lookAtTarget.current.x,
      //         lookAtTarget.current.y,
      //         value
      //       );
  ...
  return (
    <>
      ...
      <group>
        ...
        <group>
          <mesh position={[4.85, 9.7, 5.38]} ref={meshRef}>
          ...
          <spotLight
            ref={light1Ref}
            color={"white"}
            position={[9.85, 10.7, 9.38]} // em cima da quadra
            angle={Math.PI / 9} // abertura do cone
            penumbra={2} // suavidade da borda
            intensity={50} // força da luz
            castShadow
            shadow-mapSize-width={1024}
            shadow-mapSize-height={1024}
