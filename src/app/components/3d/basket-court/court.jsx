...
import { ConeCollider, ConvexHullCollider, CylinderCollider, MeshCollider, RigidBody } from '@react-three/rapier'
          ...
          <group
            ...
            <group name="RootNode" userData={{ name: 'RootNode' }}>
              ...
              <group
                ...
                <RigidBody type='fixed' position={[0, 0, 0]} colliders={'cuboid'} restitution={1}>
                  <mesh
              ...
              <group
                ...
                <RigidBody type='fixed' colliders={'hull'} friction={1} restitution={1}>
                  <mesh
              ...
              <group
                ...
                >
                  <ConeCollider
                    ...
                    onIntersectionEnter={() => {
                      ...
                      if (colliderOrderRight === "empty_right") setColliderOrderRight("top_right")
                      if (colliderOrderRight === "botton_right") setColliderOrderRight("empty_right")
                    }}
                  />
                  ...
                  <CylinderCollider
                    ...
                    sensor={true}
                    onIntersectionEnter={() => {
                      if (colliderOrderRight === "empty_right") setColliderOrderRight("botton_right")
                      if (colliderOrderRight === "botton_right") setColliderOrderRight("empty_right")
                      if (colliderOrderRight === "top_right") {
                        setColliderOrderRight("empty_right")
                        console.log(colliderOrderRight, "GOAL RIGHT")
                      }
                    }}
                  />
                ...
                <RigidBody type='fixed' colliders={'trimesh'}>
                  <mesh visible={true} position={[0, 0, 0]}>
                    ...
                    <meshPhysicalMaterial color="blue" opacity={0} transparent />
                  </mesh>
                </RigidBody>
              </group>
              <group
              ...
              <group
                ...
                <RigidBody type='fixed' colliders={'trimesh'} friction={1} restitution={1}>
                  <mesh
                  ...
                  <CylinderCollider
                    ...
                    onIntersectionEnter={() => {
                      ...
                      if (colliderOrderLeft === "top_left") {
                        ...
                        console.log(colliderOrderLeft, "GOAL left")
                      }
                    }}
                  />
