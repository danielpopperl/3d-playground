...
export default function Holographic(camera) {
  ...
  const fragmentShader = `
      ...
      void main() {
        ...
        float wave1 = sin(uv.x * 4.0 + time * 0.8) * 0.3;
        ...
        float mix_factor1 = sin(uv.x * 3.14159 + time * 0.7) * 0.5 + 1.5;
        float mix_factor2 = cos(uv.y * 3.14159 + time * 0.9) * 0.5 + 0.5;
        
        vec3 final_color = mix(color1, color2, mix_factor1);
        final_color = mix(final_color, color3, mix_factor2 * 0.3);
        
        // Add some brightness variation
        float brightness = 1.8 + sin(combined_wave + time * 0.5) * 0.2;
